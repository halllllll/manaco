...
export const mockActivities: Record<string, LearningActivity[]> = {
  ...
  'student-1': [
    { activityDate: d(27), duration: 5400, score: 98, subject: '算数', memo: '期末テストの復習。応用問題が解けた！', mood: 'happy' },
    { activityDate: d(26), duration: 4800, score: 92, subject: '国語', memo: '漢字の書き取りと、長文読解' },
    { activityDate: d(25), duration: 5000, score: 95, subject: '理科', memo: '実験レポートの清書。' },
    { activityDate: d(24), duration: 4500, score: 90, subject: '社会', memo: '歴史の年号を暗記した。' },
    { activityDate: d(23), duration: 5200, score: 96, subject: '英語', memo: '新しい文法の予習。' },
    { activityDate: d(22), duration: 3600, score: 88, subject: '読書', memo: '偉人の伝記を読んだ。' },
    { activityDate: d(21), duration: 4000, score: 91, subject: 'プログラミング' },
    { activityDate: d(20), duration: 4800, score: 93, subject: '算数' },
  ],
  'student-2': [
    { activityDate: d(26), duration: 7200, score: 95, subject: '図画工作', memo: 'コンクールの絵が完成！', mood: 'happy' },
  ...
  'student-15': [
    { activityDate: d(22), duration: 10800, score: 92, subject: '自主学習', memo: '1週間の復習。苦手なところを重点的に。' },
    { activityDate: d(21), duration: 9000, score: 88, subject: 'プログラミング', memo: '新しいゲーム作りに挑戦' },
  ...
  'student-33': [
    ...
    { activityDate: d(27), duration: 6000, score: 95, subject: 'プログラミング', memo: '作ったアプリのデバッグ' },
  ...
  'student-45': [
    { activityDate: d(27), duration: 1200, score: 55, subject: '算数', memo: '全然集中できなかった', mood: 'hard' },
    { activityDate: d(26), duration: 1000, score: 52, subject: '国語', mood: 'tired' },
    { activityDate: d(25), duration: 1500, score: 60, subject: '理科' },
  ],
  'student-50': [],
  'student-62': [
    { activityDate: d(26), duration: 3000, score: 100, subject: '音楽', memo: '合唱コンクールの練習' },
    { activityDate: d(24), duration: 3600, score: 100, subject: '体育', mood: 'happy', memo: 'サッカーの試合で活躍！' },
  ...
  // student-85: 読書家
  'student-85': [
    { activityDate: d(27), duration: 5000, score: 100, subject: '読書', memo: 'シリーズ最新刊を読破！' },
  ...
  'student-111': [
    { activityDate: d(27), duration: 900, score: 80, subject: '漢字練習', memo: 'ゆっくり丁寧に書いた' },
  ...
  'student-114': [
    ...
    { activityDate: d(26), duration: 1800, score: 70, subject: '国語', memo: '漢字が難しい', mood: 'hard' },
